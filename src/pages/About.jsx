...
const About = () => {
        ...
        return (
            <div ref={ref} className="mb-4 md:w-80 w-[80vw] lg:mx-10 mx-8">
                <div className="flex justify-between mb-0">
                    ...
                    <span className="text-black/60 mt-auto">{level}%</span>
                </div>
    ...
    return (
        <div>
            ...
            >
                <p className="text-3xl text-black/80 text-center pb-5">Skills</p>
            ...
            >
                <div className="flex flex-col gap-5">
                    <p className="text-3xl text-black/80">Job Experience</p>
                    <div>
                        <p className="font-semibold text-lg text-black/60">Design Engineer</p>
                    ...
                    <div>
                        <p className="font-semibold text-lg text-black/60">Technical Engineer</p>
                        <div className="text-black/50">
                ...
                <div className="flex flex-col gap-5">
                    <p className="text-3xl text-black/80">Education</p>
                    <div>
                        <p className="font-semibold text-lg text-black/60">Full-Stack Web Development</p>
                        <div className="text-black/50">
                    ...
                    <div>
                        <div className="font-semibold text-lg text-black/60">
